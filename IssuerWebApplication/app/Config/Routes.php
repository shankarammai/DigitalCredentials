...
$routes->match(['get', 'post'], '/api/sendDocs', 'Home::sendDocuments');
$routes->get('/DigitalCredentials', 'Home::docs');
$routes->get('/Verify', 'Home::Verify');
$routes->match(['get', 'post'], '/dashboard', 'Home::dashboard');
$routes->get('/api/getIssuers', 'Home::getIssuers');
$routes->get('/api/showCredential/(:any)?', 'Home::loadShowCredential/$1/$2'); 
// $routes->match(['get', 'post'], '/api/saveShowCredential/', 'Home::showCredDataSave');
